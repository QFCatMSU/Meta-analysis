...
mod.ns1 = rma(yi=d, vi=var.d, mods=~year.parity+factor(Predator), method="DL", data=data, btt=2)
mod.ns2 = rma(yi=d, vi=var.d, mods=~name.parity+factor(Predator), method="DL", data=data, btt=2)
mod.ns3 = rma(yi=d, vi=var.d, mods=~name.rank+factor(Predator), method="DL", data=data, btt=2)
mod.ns4 = rma(yi=d, vi=var.d, mods=~name.vowels+factor(Predator), method="DL", data=data, btt=2)
p.ns = c(mod.ns1$QMp, mod.ns2$QMp, mod.ns3$QMp, mod.ns4$QMp)

mod.p.ns1 = rma.mv(yi=d, V=var.d, mods=~year.parity+factor(Predator), random=list(~1|Paper,~1|study), data=data, btt=2)
mod.p.ns2 = rma.mv(yi=d, V=var.d, mods=~name.parity+factor(Predator), random=list(~1|Paper,~1|study), data=data, btt=2)
mod.p.ns3 = rma.mv(yi=d, V=var.d, mods=~name.rank+factor(Predator), random=list(~1|Paper,~1|study), data=data, btt=2)
mod.p.ns4 = rma.mv(yi=d, V=var.d, mods=~name.vowels+factor(Predator), random=list(~1|Paper,~1|study), data=data, btt=2)

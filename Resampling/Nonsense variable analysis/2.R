...
mod.ns1 = rma(yi=g, vi=var.g, mods=~year.parity + factor(Ecosystem_service_indicator), data=data, btt=2)
mod.ns2 = rma(yi=g, vi=var.g, mods=~name.parity + factor(Ecosystem_service_indicator), data=data, btt=2)
mod.ns3 = rma(yi=g, vi=var.g, mods=~name.rank + factor(Ecosystem_service_indicator), data=data, btt=2)
mod.ns4 = rma(yi=g, vi=var.g, mods=~name.vowels + factor(Ecosystem_service_indicator), data=data, btt=2)
p.ns = c(mod.ns1$QMp, mod.ns2$QMp, mod.ns3$QMp, mod.ns4$QMp)

mod.p.ns1 = rma.mv(yi=g, V=var.g, mods=~year.parity+factor(Ecosystem_service_indicator), random=list(~1|ID, ~1|study), data=data, btt=2)
mod.p.ns2 = rma.mv(yi=g, V=var.g, mods=~name.parity+factor(Ecosystem_service_indicator), random=list(~1|ID, ~1|study), data=data, btt=2)
mod.p.ns3 = rma.mv(yi=g, V=var.g, mods=~name.rank+factor(Ecosystem_service_indicator), random=list(~1|ID, ~1|study), data=data, btt=2)
mod.p.ns4 = rma.mv(yi=g, V=var.g, mods=~name.vowels+factor(Ecosystem_service_indicator), random=list(~1|ID, ~1|study), data=data, btt=2)

...
mod.ns1 = rma(yi=C, sei=se.C, mods=~year.parity+factor(Organism), data=data, btt=2)
mod.ns2 = rma(yi=C, sei=se.C, mods=~name.parity+factor(Organism), data=data, btt=2)
mod.ns3 = rma(yi=C, sei=se.C, mods=~name.rank+factor(Organism), data=data, btt=2)
mod.ns4 = rma(yi=C, sei=se.C, mods=~name.vowels+factor(Organism), data=data, btt=2)
p.ns = c(mod.ns1$QMp, mod.ns2$QMp, mod.ns3$QMp, mod.ns4$QMp)

mod.p.ns1 = rma.mv(yi=C, V=se.C^2, mods=~year.parity+factor(Organism), random=list(~1|Paper,~1|study), data=data, btt=2)
mod.p.ns2 = rma.mv(yi=C, V=se.C^2, mods=~name.parity+factor(Organism), random=list(~1|Paper,~1|study), data=data, btt=2)
mod.p.ns3 = rma.mv(yi=C, V=se.C^2, mods=~name.rank+factor(Organism), random=list(~1|Paper,~1|study), data=data, btt=2)
mod.p.ns4 = rma.mv(yi=C, V=se.C^2, mods=~name.vowels+factor(Organism), random=list(~1|Paper,~1|study), data=data, btt=2)

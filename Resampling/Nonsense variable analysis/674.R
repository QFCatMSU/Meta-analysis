...
mod.ns1 = rma(yi=RR, vi=RR.var, mods=~year.parity+factor(Type), data=data, btt=2)
mod.ns2 = rma(yi=RR, vi=RR.var, mods=~name.parity+factor(Type), data=data, btt=2)
mod.ns3 = rma(yi=RR, vi=RR.var, mods=~name.rank+factor(Type), data=data, btt=2)
mod.ns4 = rma(yi=RR, vi=RR.var, mods=~name.vowels+factor(Type), data=data, btt=2)
p.ns = c(mod.ns1$QMp, mod.ns2$QMp, mod.ns3$QMp, mod.ns4$QMp)

mod.p.ns1 = rma.mv(yi=RR, V=RR.var, mods=~year.parity+factor(Type), random=list(~1|Reference,~1|study), data=data, btt=2)
mod.p.ns2 = rma.mv(yi=RR, V=RR.var, mods=~name.parity+factor(Type), random=list(~1|Reference,~1|study), data=data, btt=2)
mod.p.ns3 = rma.mv(yi=RR, V=RR.var, mods=~name.rank+factor(Type), random=list(~1|Reference,~1|study), data=data, btt=2)
mod.p.ns4 = rma.mv(yi=RR, V=RR.var, mods=~name.vowels+factor(Type), random=list(~1|Reference,~1|study), data=data, btt=2)
